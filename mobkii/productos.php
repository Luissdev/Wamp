        ...
        <div id="menu">
            <div class="pure-menu">
                ...
                <ul class="pure-menu-list">
                    ...
                    <li class="pure-menu-item"><a href="" id="loadproductos" class="pure-menu-link">Productos</a></li>
                </ul>
            </div>
        </div>
        <div id="productos">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select required name="categoria">
                                        <option value="A" <?php echo $alm->__GET('categoria') == 'A' ? 'selected' : ''; ?>>A</option>
                                        <option value="B" <?php echo $alm->__GET('categoria') == 'B' ? 'selected' : ''; ?>>B</option>
                                        <option value="C" <?php echo $alm->__GET('categoria') == 'C' ? 'selected' : ''; ?>>C</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
